...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/6.102.0/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: v4.102.0' . PHP_EOL;
        $report .= '    SDK Package Version: 6.102.0' . PHP_EOL;
