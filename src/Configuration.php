...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/6.104.3/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: v4.104.3' . PHP_EOL;
        $report .= '    SDK Package Version: 6.104.3' . PHP_EOL;
