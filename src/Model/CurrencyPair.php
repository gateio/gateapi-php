...
class CurrencyPair implements ModelInterface, ArrayAccess
{
     ...
     * Sets trade_status
     *
     * @param string|null $trade_status How currency pair can be traded  - untradable: cannot be bought or sold - buyable: can be bought - sellable: can be sold - tradable: sold
     *
     * @return $this
     */
