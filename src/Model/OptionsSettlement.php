...
/**
 * OptionsSettlement Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class OptionsSettlement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptionsSettlement';
     ...
     * Sets time
     *
     * @param double|null $time Last configuration update time
     *
     * @return $this
     */
     ...
     * Sets profit
     *
     * @param string|null $profit Settlement profit per contract (quote currency)
     *
     * @return $this
     */
     ...
     * Sets fee
     *
     * @param string|null $fee Settlement fee per contract (quote currency)
     *
     * @return $this
     */
