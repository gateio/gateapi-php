...
class OrderPatch implements ModelInterface, ArrayAccess
{
     ...
     * Sets amount
     *
     * @param string|null $amount Trading quantity. Either `amount` or `price` must be specified
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param string|null $price Trading price. Either `amount` or `price` must be specified
     *
     * @return $this
     */
