...
class SubAccountToSubAccount implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $sub_account_type Transfer from account (deprecated, use `sub_account_from_type` and `sub_account_to_type` instead)
     *
     * @return $this
     */
     ...
     *
     * @param string $sub_account_from_type Source sub-account trading account: spot - spot account, futures - perpetual contract account, delivery - delivery contract account
     *
     * @return $this
     */
     ...
     *
     * @param string $sub_account_to_type Target sub-account trading account: spot - spot account, futures - perpetual contract account, delivery - delivery contract account
     *
     * @return $this
     */
