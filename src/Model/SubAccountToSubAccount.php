...
class SubAccountToSubAccount implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $sub_account_to_type Transferred sub-account trading account: spot - spot account, futures - perpetual contract account, delivery - delivery contract account
     *
     * @return $this
     */
