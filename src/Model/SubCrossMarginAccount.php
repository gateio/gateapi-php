...
class SubCrossMarginAccount implements ModelInterface, ArrayAccess
{
     ...
     * Sets user_id
     *
     * @param int|null $user_id Cross margin account user ID. 0 means this sub-account has not yet opened a cross margin account
     *
     * @return $this
     */
     ...
     * Sets locked
     *
     * @param bool|null $locked Whether the account is locked
     *
     * @return $this
     */
     ...
     * Sets borrowed_net
     *
     * @param string|null $borrowed_net Total borrowed value in USDT * leverage factor
     *
     * @return $this
     */
     ...
     * Sets interest
     *
     * @param string|null $interest Total unpaid interest in USDT, i.e., the sum of all currencies' `interest*price*discount`
     *
     * @return $this
     */
     ...
     * Sets risk
     *
     * @param string|null $risk Risk rate. When it falls below 110%, liquidation will be triggered. Calculation formula: `total / (borrowed+interest)`
     *
     * @return $this
     */
