 ...
 *
 * @category Class
 * @description Sub-broker information
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class BrokerCommissionSubBrokerInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets user_id
     *
     * @param int|null $user_id Sub-broker user ID
     *
     * @return $this
     */
     ...
     *
     * @param string|null $original_commission_rate Sub-broker original commission rate
     *
     * @return $this
     */
     ...
     *
     * @param string|null $relative_commission_rate Sub-broker relative commission rate
     *
     * @return $this
     */
     ...
     *
     * @param string|null $commission_rate Sub-broker actual commission rate
     *
     * @return $this
     */
