...
class TradeFee implements ModelInterface, ArrayAccess
{
     ...
     * Sets gt_discount
     *
     * @param bool|null $gt_discount Whether GT deduction discount is enabled
     *
     * @return $this
     */
     ...
     * Sets gt_maker_fee
     *
     * @param string|null $gt_maker_fee Maker fee rate with GT deduction. Returns 0 if GT deduction is disabled
     *
     * @return $this
     */
     ...
     * Sets point_type
     *
     * @param string|null $point_type Point card type: 0 - Original version, 1 - New version since 202009
     *
     * @return $this
     */
     ...
     *
     * @param string|null $futures_taker_fee Perpetual contract taker fee rate
     *
     * @return $this
     */
     ...
     *
     * @param string|null $futures_maker_fee Perpetual contract maker fee rate
     *
     * @return $this
     */
     ...
     *
     * @param string|null $delivery_taker_fee Delivery contract taker fee rate
     *
     * @return $this
     */
     ...
     *
     * @param string|null $delivery_maker_fee Delivery contract maker fee rate
     *
     * @return $this
     */
