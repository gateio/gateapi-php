 ...
 * @link     https://www.gate.com
 */
class UnifiedLoanRecord implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnifiedLoanRecord';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['borrow_type'] = isset($data['borrow_type']) ? $data['borrow_type'] : null;
     ...
     * Sets repayment_type
     *
     * @param string|null $repayment_type Repayment type: none - No repayment type, manual_repay - Manual repayment, auto_repay - Automatic repayment, cancel_auto_repay - Automatic repayment after order cancellation, different_currencies_repayment - Cross-currency repayment
     *
     * @return $this
     */
    ...
    {
        return $this->container['borrow_type'];
    }

    /**
     * Sets borrow_type
     *
     * @param string|null $borrow_type Borrowing type, returned when querying loan records: manual_borrow - Manual borrowing, auto_borrow - Automatic borrowing
     *
     * @return $this
     */
    public function setBorrowType($borrow_type)
    {
        $this->container['borrow_type'] = $borrow_type;
     ...
     * Sets amount
     *
     * @param string|null $amount Borrow or repayment amount
     *
     * @return $this
     */
