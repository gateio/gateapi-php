...
class UserSub implements ModelInterface, ArrayAccess
{
     ...
     * Sets belong
     *
     * @param string|null $belong User's system affiliation (partner/referral). Empty means not belonging to any system
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param int|null $type Type (0-Not in system 1-Direct subordinate agent 2-Indirect subordinate agent 3-Direct direct customer 4-Indirect direct customer 5-Regular user)
     *
     * @return $this
     */
