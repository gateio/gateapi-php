 ...
 *
 * @category Class
 * @description Spot liquidation order details
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class LiquidateOrder implements ModelInterface, ArrayAccess
{
     ...
     * Sets action_mode
     *
     * @param string|null $action_mode Processing mode:  Different fields are returned when placing an order based on action_mode. This field is only valid during the request and is not included in the response `ACK`: Asynchronous mode, only returns key order fields `RESULT`: No liquidation information `FULL`: Full mode (default)
     *
     * @return $this
     */
