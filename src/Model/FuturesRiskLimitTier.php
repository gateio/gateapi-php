 ...
 *
 * @category Class
 * @description Information for each tier of the gradient risk limit table
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class FuturesRiskLimitTier implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FuturesRiskLimitTier';
