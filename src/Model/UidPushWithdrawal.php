...
/**
 * UidPushWithdrawal Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   GateIO
 * @link     https://www.gate.io
 */
class UidPushWithdrawal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UidPushWithdrawal';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['receive_uid'] === null) {
            $invalidProperties[] = "'receive_uid' can't be null";
        }
