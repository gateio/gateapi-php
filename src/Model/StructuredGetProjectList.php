 ...
 *
 * @category Class
 * @description Structured Investment
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class StructuredGetProjectList implements ModelInterface, ArrayAccess
{
     ...
     * Sets type
     *
     * @param string|null $type Product Type:   `SharkFin2.0`-Shark Fin 2.0  `BullishSharkFin`-Bullish Shark Fin  `BearishSharkFin`-Bearish Shark Fin `DoubleNoTouch`-Double No-Touch `RangeAccrual`-Range Accrual `SnowBall`-Snow Ball
     *
     * @return $this
     */
     ...
     * Sets name_en
     *
     * @param string|null $name_en Product Name
     *
     * @return $this
     */
     ...
     *
     * @param string|null $investment_coin Investment Token
     *
     * @return $this
     */
     ...
     *
     * @param string|null $investment_period Investment Period
     *
     * @return $this
     */
     ...
     * Sets watch_market
     *
     * @param string|null $watch_market Underlying Market
     *
     * @return $this
     */
