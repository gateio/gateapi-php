...
class FuturesPriceTriggeredOrder implements ModelInterface, ArrayAccess
{
     ...
     * Sets create_time
     *
     * @param double|null $create_time Created time
     *
     * @return $this
     */
     ...
     * Sets finish_time
     *
     * @param double|null $finish_time End time
     *
     * @return $this
     */
     ...
     * Sets trade_id
     *
     * @param int|null $trade_id ID of the order created after trigger
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Order status  - `open`: Active - `finished`: Finished - `inactive`: Inactive, only applies to order take-profit/stop-loss - `invalid`: Invalid, only applies to order take-profit/stop-loss
     *
     * @return $this
     */
     ...
     * Sets finish_as
     *
     * @param string|null $finish_as Finish status: cancelled - Cancelled; succeeded - Succeeded; failed - Failed; expired - Expired
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Additional description of how the order was completed
     *
     * @return $this
     */
     ...
     * Sets order_type
     *
     * @param string|null $order_type Types of take-profit and stop-loss orders, including:  - `close-long-order`: Order take-profit/stop-loss, close long position - `close-short-order`: Order take-profit/stop-loss, close short position - `close-long-position`: Position take-profit/stop-loss, used to close all long positions - `close-short-position`: Position take-profit/stop-loss, used to close all short positions - `plan-close-long-position`: Position plan take-profit/stop-loss, used to close all or partial long positions - `plan-close-short-position`: Position plan take-profit/stop-loss, used to close all or partial short positions  The two types of order take-profit/stop-loss are read-only and cannot be passed in requests
     *
     * @return $this
     */
     ...
     * Sets me_order_id
     *
     * @param int|null $me_order_id Corresponding order ID for order take-profit/stop-loss orders
     *
     * @return $this
     */
