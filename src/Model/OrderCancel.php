...
class OrderCancel implements ModelInterface, ArrayAccess
{
     ...
     * Sets succeeded
     *
     * @param bool|null $succeeded Request execution result
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param string|null $price Trading price, required when `type`=`limit`
     *
     * @return $this
     */
     ...
     * Sets filled_amount
     *
     * @param string|null $filled_amount Amount filled
     *
     * @return $this
     */
     ...
     * Sets gt_maker_fee
     *
     * @param string|null $gt_maker_fee GT amount used to deduct maker fee
     *
     * @return $this
     */
     ...
     * Sets gt_taker_fee
     *
     * @param string|null $gt_taker_fee GT amount used to deduct taker fee
     *
     * @return $this
     */
     ...
     * Sets gt_discount
     *
     * @param bool|null $gt_discount Whether GT fee deduction is enabled
     *
     * @return $this
     */
