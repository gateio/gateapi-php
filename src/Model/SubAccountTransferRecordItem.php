...
class SubAccountTransferRecordItem implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $sub_account_type Target sub-account trading account: spot - spot account, futures - perpetual contract account, delivery - delivery contract account, options - options account
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string|null $source Source of the transfer operation
     *
     * @return $this
     */
     ...
     *
     * @param string|null $client_order_id Customer-defined ID to prevent duplicate transfers. Can be a combination of letters (case-sensitive), numbers, hyphens '-', and underscores '_'. Can be pure letters or pure numbers with length between 1-64 characters
     *
     * @return $this
     */
