...
class AgencyCommission implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int|null $commission_time Commission time (Unix timestamp in seconds)
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string|null $source Commission source: SPOT - Spot commission, FUTURES - Futures commission
     *
     * @return $this
     */
