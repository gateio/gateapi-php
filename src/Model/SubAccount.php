...
class SubAccount implements ModelInterface, ArrayAccess
{
     ...
     * Sets state
     *
     * @param int|null $state Sub-account status: 1-normal, 2-locked
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param int|null $type Sub-account type: 1-Regular sub-account, 3-Cross margin sub-account
     *
     * @return $this
     */
     ...
     * Sets user_id
     *
     * @param int|null $user_id Sub-account user ID
     *
     * @return $this
     */
