...
class Trade implements ModelInterface, ArrayAccess
{
     ...
     * Sets create_time
     *
     * @param string|null $create_time Fill Time
     *
     * @return $this
     */
     ...
     * Sets role
     *
     * @param string|null $role Trade role, not returned in public endpoints
     *
     * @return $this
     */
     ...
     * Sets order_id
     *
     * @param string|null $order_id Related order ID, not returned in public endpoints
     *
     * @return $this
     */
     ...
     * Sets fee
     *
     * @param string|null $fee Fee deducted, not returned in public endpoints
     *
     * @return $this
     */
     ...
     * Sets fee_currency
     *
     * @param string|null $fee_currency Fee currency unit, not returned in public endpoints
     *
     * @return $this
     */
     ...
     * Sets point_fee
     *
     * @param string|null $point_fee Points used to deduct fee, not returned in public endpoints
     *
     * @return $this
     */
     ...
     * Sets gt_fee
     *
     * @param string|null $gt_fee GT used to deduct fee, not returned in public endpoints
     *
     * @return $this
     */
     ...
     * Sets sequence_id
     *
     * @param string|null $sequence_id Consecutive trade ID within a single market. Used to track and identify trades in the specific market
     *
     * @return $this
     */
