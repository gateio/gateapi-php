...
class BatchAmendItem implements ModelInterface, ArrayAccess
{
     ...
     * Sets amount
     *
     * @param string|null $amount Trading Quantity. Only one of `amount` or `price` can be specified
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param string|null $price Trading Price. Only one of `amount` or `price` can be specified
     *
     * @return $this
     */
