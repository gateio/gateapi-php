 ...
 *
 * @category Class
 * @description User&#39;s total borrowing and collateral amount
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class UserTotalAmount implements ModelInterface, ArrayAccess
{
     ...
     * Sets borrow_amount
     *
     * @param string|null $borrow_amount Total borrowing amount in USDT
     *
     * @return $this
     */
     ...
     *
     * @param string|null $collateral_amount Total collateral amount in USDT
     *
     * @return $this
     */
