 ...
 * @link     https://www.gate.io
 */
class CollateralLoanCurrency implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CollateralLoanCurrency';
    ...
    {
        $this->container['loan_currency'] = isset($data['loan_currency']) ? $data['loan_currency'] : null;
    ...
    {
        return $this->container['loan_currency'];
    }
     ...
     * @return $this
     */
    public function setLoanCurrency($loan_currency)
    {
        $this->container['loan_currency'] = $loan_currency;
