...
class Transfer implements ModelInterface, ArrayAccess
{
     ...
     * Sets currency
     *
     * @param string $currency Transfer currency name. For contract accounts, `currency` can be set to `POINT` (points) or supported settlement currencies (e.g., `BTC`, `USDT`)
     *
     * @return $this
     */
     ...
     * Sets currency_pair
     *
     * @param string|null $currency_pair Margin trading pair. Required when transferring to or from margin account
     *
     * @return $this
     */
     ...
     * Sets settle
     *
     * @param string|null $settle Contract settlement currency. Required when transferring to or from contract account
     *
     * @return $this
     */
