...
class OptionsMySettlements implements ModelInterface, ArrayAccess
{
     ...
     * Sets size
     *
     * @param int|null $size Settlement size
     *
     * @return $this
     */
     ...
     * Sets fee
     *
     * @param string|null $fee Settlement fee (quote currency)
     *
     * @return $this
     */
     ...
     * Sets realised_pnl
     *
     * @param string|null $realised_pnl Accumulated profit and loss from opening positions, including premium, fees, settlement profit, etc. (quote currency)
     *
     * @return $this
     */
