 ...
 *
 * @category Class
 * @description Currency account information
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class MarginAccountCurrency implements ModelInterface, ArrayAccess
{
     ...
     * Sets available
     *
     * @param string|null $available Amount available for margin trading, available = margin + borrowed
     *
     * @return $this
     */
     ...
     * Sets locked
     *
     * @param string|null $locked Frozen funds, such as amounts already placed in margin market for order trading
     *
     * @return $this
     */
     ...
     * Sets borrowed
     *
     * @param string|null $borrowed Borrowed funds
     *
     * @return $this
     */
     ...
     * Sets interest
     *
     * @param string|null $interest Unpaid interest
     *
     * @return $this
     */
