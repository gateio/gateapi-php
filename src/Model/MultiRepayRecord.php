 ...
 *
 * @category Class
 * @description Multi-Collateral Repayment Record
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class MultiRepayRecord implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \GateApi\Model\RepayRecordLeftInterest[]|null $left_repay_interest_list List of remaining interest to be repaid
     *
     * @return $this
     */
