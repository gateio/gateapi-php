...
class CreateMultiCollateralOrder implements ModelInterface, ArrayAccess
{
     ...
     * Sets order_type
     *
     * @param string|null $order_type current - current rate, fixed - fixed rate, defaults to current if not specified
     *
     * @return $this
     */
     ...
     * Sets fixed_type
     *
     * @param string|null $fixed_type Fixed interest rate lending period: 7d - 7 days, 30d - 30 days. Required for fixed rate
     *
     * @return $this
     */
     ...
     * Sets fixed_rate
     *
     * @param string|null $fixed_rate Fixed interest rate, required for fixed rate
     *
     * @return $this
     */
     ...
     * Sets borrow_amount
     *
     * @param string $borrow_amount Borrowed amount
     *
     * @return $this
     */
