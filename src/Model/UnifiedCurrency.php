...
class UnifiedCurrency implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $min_borrow_amount Minimum borrowable limit, in currency units
     *
     * @return $this
     */
     ...
     *
     * @param string|null $user_max_borrow_amount User's maximum borrowable limit, in USDT
     *
     * @return $this
     */
     ...
     *
     * @param string|null $total_max_borrow_amount Platform's maximum borrowable limit, in USDT
     *
     * @return $this
     */
     ...
     * Sets loan_status
     *
     * @param string|null $loan_status Lending status  - `disable` : Lending prohibited  - `enable` : Lending supported
     *
     * @return $this
     */
