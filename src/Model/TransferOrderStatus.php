...
class TransferOrderStatus implements ModelInterface, ArrayAccess
{
     ...
     * Sets status
     *
     * @param string|null $status Transfer status: PENDING - Processing, SUCCESS - Transfer successful, FAIL - Transfer failed, PARTIAL_SUCCESS - Partially successful (this status appears when transferring between sub-accounts)
     *
     * @return $this
     */
