...
class SpotPriceTriggeredOrder implements ModelInterface, ArrayAccess
{
     ...
     * Sets ctime
     *
     * @param int|null $ctime Created time
     *
     * @return $this
     */
     ...
     * Sets fired_order_id
     *
     * @param int|null $fired_order_id ID of the order created after trigger
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Status  - open: Running - cancelled: Manually cancelled - finish: Successfully completed - failed: Failed to execute - expired: Expired
     *
     * @return $this
     */
