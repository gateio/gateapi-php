...
class UnifiedBalance implements ModelInterface, ArrayAccess
{
     ...
     * Sets borrowed
     *
     * @param string|null $borrowed Borrowed amount, valid in cross-currency margin/combined margin mode, 0 in other modes such as single-currency margin mode
     *
     * @return $this
     */
     ...
     * Sets negative_liab
     *
     * @param string|null $negative_liab Negative balance borrowing, valid in cross-currency margin/combined margin mode, 0 in other modes such as single-currency margin mode
     *
     * @return $this
     */
     ...
     * Sets total_freeze
     *
     * @param string|null $total_freeze Total frozen (deprecated, to be removed)
     *
     * @return $this
     */
     ...
     * Sets total_liab
     *
     * @param string|null $total_liab Total borrowed amount, valid in cross-currency margin/combined margin mode, 0 in other modes such as single-currency margin mode
     *
     * @return $this
     */
