...
class OptionsPositionClose implements ModelInterface, ArrayAccess
{
     ...
     * Sets side
     *
     * @param string|null $side Position side  - `long`: Long position - `short`: Short position
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param string|null $text Source of close order. See `order.text` field for specific values
     *
     * @return $this
     */
