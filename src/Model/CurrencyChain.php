...
class CurrencyChain implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int|null $is_deposit_disabled Is deposit disabled. 0 means not disabled
     *
     * @return $this
     */
     ...
     *
     * @param int|null $is_withdraw_disabled Is withdrawal disabled. 0 means not disabled
     *
     * @return $this
     */
