 ...
 *
 * @category Class
 * @description Options order details
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class OptionsOrder implements ModelInterface, ArrayAccess
{
     ...
     * Sets contract
     *
     * @param string $contract Options identifier
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param string|null $price Order price. Price of 0 with `tif` set as `ioc` represents market order (quote currency)
     *
     * @return $this
     */
     ...
     * Sets mmp
     *
     * @param bool|null $mmp When set to true, it is an MMP order
     *
     * @return $this
     */
     ...
     * Sets is_mmp
     *
     * @param bool|null $is_mmp Whether it is an MMP order. Corresponds to `mmp` in the request
     *
     * @return $this
     */
     ...
     * Sets tif
     *
     * @param string|null $tif Time in force strategy. Market orders currently only support IOC mode  - gtc: Good Till Cancelled - ioc: Immediate Or Cancelled, execute immediately or cancel, taker only - poc: Pending Or Cancelled, passive order, maker only
     *
     * @return $this
     */
