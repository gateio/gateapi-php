 ...
 *
 * @category Class
 * @description Flash swap order preview
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class FlashSwapOrderPreview implements ModelInterface, ArrayAccess
{
     ...
     * Sets sell_currency
     *
     * @param string|null $sell_currency Name of the sold asset,  Refer to the interface Query the list of currencies supported for flash swap GET /flash_swap/currenciesto obtain
     *
     * @return $this
     */
     ...
     * Sets buy_currency
     *
     * @param string|null $buy_currency Name of the purchased asset,  Refer to the interface Query the list of currencies supported for flash swap GET /flash_swap/currenciesto obtain
     *
     * @return $this
     */
