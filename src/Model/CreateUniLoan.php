 ...
 * @link     https://www.gate.com
 */
class CreateUniLoan implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateUniLoan';
     ...
     * Sets repaid_all
     *
     * @param bool|null $repaid_all Full repayment. For repayment operations only. When `true`, overrides `amount` and repays the full amount
     *
     * @return $this
     */
