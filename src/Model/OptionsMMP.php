...
/**
 * OptionsMMP Class Doc Comment
 *
 * @category Class
 * @description MMP Settings
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class OptionsMMP implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptionsMMP';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['frozen_period'] === null) {
            $invalidProperties[] = "'frozen_period' can't be null";
        }
        if ($this->container['qty_limit'] === null) {
            $invalidProperties[] = "'qty_limit' can't be null";
        }
        if ($this->container['delta_limit'] === null) {
            $invalidProperties[] = "'delta_limit' can't be null";
        }
     ...
     * Sets window
     *
     * @param int $window Time window (milliseconds), between 1-5000, 0 means disable MMP
     *
     * @return $this
     */
