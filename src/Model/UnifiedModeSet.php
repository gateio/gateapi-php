...
class UnifiedModeSet implements ModelInterface, ArrayAccess
{
     ...
     * Sets mode
     *
     * @param string $mode Unified account mode:  - `classic`: Classic account mode - `multi_currency`: Cross-currency margin mode - `portfolio`: Portfolio margin mode - `single_currency`: Single-currency margin mode
     *
     * @return $this
     */
