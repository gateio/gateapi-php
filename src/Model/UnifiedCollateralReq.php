...
class UnifiedCollateralReq implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int|null $collateral_type User-set collateral mode: 0(all)-All currencies as collateral, 1(custom)-Custom currencies as collateral. When collateral_type is 0(all), enable_list and disable_list parameters are invalid
     *
     * @return $this
     */
     ...
     * Sets enable_list
     *
     * @param string[]|null $enable_list Currency list, where collateral_type=1(custom) indicates the addition logic
     *
     * @return $this
     */
     ...
     * Sets disable_list
     *
     * @param string[]|null $disable_list Disable list, indicating the disable logic
     *
     * @return $this
     */
