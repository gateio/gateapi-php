...
class UidPushOrder implements ModelInterface, ArrayAccess
{
     ...
     * Sets status
     *
     * @param string|null $status Withdrawal status:  - CREATING: Creating - PENDING: Waiting for recipient (Please contact the recipient to accept the transfer on Gate official website) - CANCELLING: Cancelling - CANCELLED: Cancelled - REFUSING: Refusing - REFUSED: Refused - RECEIVING: Receiving - RECEIVED: Success
     *
     * @return $this
     */
