...
class UnifiedAccount implements ModelInterface, ArrayAccess
{
     ...
     * Sets refresh_time
     *
     * @param int|null $refresh_time Last refresh time
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param string|null $total Total account assets converted to USD, i.e. the sum of `(available + freeze) * price` in all currencies (deprecated, to be removed, replaced by unified_account_total)
     *
     * @return $this
     */
     ...
     * Sets borrowed
     *
     * @param string|null $borrowed Total borrowed amount converted to USD, i.e. the sum of `borrowed * price` of all currencies (excluding point cards), valid in cross-currency margin/combined margin mode, 0 in other modes such as single-currency margin mode
     *
     * @return $this
     */
     ...
     * Sets spot_hedge
     *
     * @param bool|null $spot_hedge Spot hedging status: true - enabled, false - disabled
     *
     * @return $this
     */
     ...
     * Sets use_funding
     *
     * @param bool|null $use_funding Whether to use Earn funds as margin
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $is_all_collateral Whether all currencies are used as margin: true - all currencies as margin, false - no
     *
     * @return $this
     */
