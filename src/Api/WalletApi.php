...
class WalletApi
{
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $client_order_id Customer-defined ID to prevent duplicate transfers. Can be a combination of letters (case-sensitive), numbers, hyphens &#39;-&#39;, and underscores &#39;_&#39;. Can be pure letters or pure numbers with length between 1-64 characters (optional)
     * @param  string $tx_id Transfer operation number, cannot be empty at the same time as client_order_id (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $sub_uid Sub-account user ID, you can query multiple records separated by &#x60;,&#x60;. If not specified, it will return records of all sub-accounts (optional)
     * @param  string $settle Query balance of specified settlement currency (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $settle Specify the settlement currency of the contract to get more accurate fee settings.  This field is optional. Generally, the fee settings for all settlement currencies are the same. (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $currency Target currency type for statistical conversion. Accepts BTC, CNY, USD, and USDT. USDT is the default value (optional, default to 'USDT')
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $currency Currency to convert (optional)
     * @param  int $page Page number (optional, default to 1)
     ...
     * @param  int $from Start time for querying records. If not specified, defaults to 7 days before the current time. Unix timestamp in seconds (optional)
     * @param  int $to End time for querying records. If not specified, defaults to the current time. Unix timestamp in seconds (optional)
     * @param  int $limit Maximum number of items returned in the list, default value is 100 (optional, default to 100)
     * @param  int $offset List offset, starting from 0 (optional, default to 0)
     * @param  string $transaction_type Order type returned in the list: &#x60;withdraw&#x60;, &#x60;deposit&#x60;. Default is &#x60;withdraw&#x60;. (optional, default to 'withdraw')
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
