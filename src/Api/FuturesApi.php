...
class FuturesApi
{
     ...
     */
    public function listLiquidates($contract = null, $limit = 100, $at = 0)
    {
        list($response) = $this->listLiquidatesWithHttpInfo($contract, $limit, $at);
        return $response;
    }
     ...
     */
    public function listLiquidatesWithHttpInfo($contract = null, $limit = 100, $at = 0)
    {
        $request = $this->listLiquidatesRequest($contract, $limit, $at);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listLiquidatesAsync($contract = null, $limit = 100, $at = 0)
    {
        return $this->listLiquidatesAsyncWithHttpInfo($contract, $limit, $at)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listLiquidatesAsyncWithHttpInfo($contract = null, $limit = 100, $at = 0)
    {
        $returnType = '\GateApi\Model\FuturesLiquidate[]';
        $request = $this->listLiquidatesRequest($contract, $limit, $at);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listLiquidatesRequest($contract = null, $limit = 100, $at = 0)
    {
        if ($limit !== null && $limit > 1000) {
        ...
        $resourcePath = '/futures/liquidates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
