...
class WithdrawalApi
{
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\UidPushWithdrawalResp
     */
    public function withdrawPushOrder($uid_push_withdrawal)
    {
        list($response) = $this->withdrawPushOrderWithHttpInfo($uid_push_withdrawal);
        return $response;
    }
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\UidPushWithdrawalResp, HTTP status code, HTTP response headers (array of strings)
     */
    public function withdrawPushOrderWithHttpInfo($uid_push_withdrawal)
    {
        $request = $this->withdrawPushOrderRequest($uid_push_withdrawal);
        ...
        $returnType = '\GateApi\Model\UidPushWithdrawalResp';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function withdrawPushOrderAsync($uid_push_withdrawal)
    {
        return $this->withdrawPushOrderAsyncWithHttpInfo($uid_push_withdrawal)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function withdrawPushOrderAsyncWithHttpInfo($uid_push_withdrawal)
    {
        $returnType = '\GateApi\Model\UidPushWithdrawalResp';
        $request = $this->withdrawPushOrderRequest($uid_push_withdrawal);
    ...
    /**
     * Create request for operation 'withdrawPushOrder'
     *
     * @param  \GateApi\Model\UidPushWithdrawal $uid_push_withdrawal (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function withdrawPushOrderRequest($uid_push_withdrawal)
    {
        // verify the required parameter 'uid_push_withdrawal' is set
        if ($uid_push_withdrawal === null || (is_array($uid_push_withdrawal) && count($uid_push_withdrawal) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $uid_push_withdrawal when calling withdrawPushOrder'
            );
        }

        $resourcePath = '/withdrawals/push';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($uid_push_withdrawal)) {
            $_tempBody = $uid_push_withdrawal;
        }
