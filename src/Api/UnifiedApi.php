...
class UnifiedApi
{
     ...
     *
     * @param  string[] $currencies Specify currency names for querying in an array, separated by commas, maximum 10 currencies (required)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $type Loan type: platform borrowing - platform, margin borrowing - margin (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $type Loan record type: borrow - borrowing, repay - repayment (optional)
     * @param  string $currency Query by specified currency name (optional)
     * @param  int $page Page number (optional, default to 1)
     * @param  int $limit Maximum number of items returned. Default: 100, minimum: 1, maximum: 100 (optional, default to 100)
     *
     ...
     * @param  string $type Loan type: platform borrowing - platform, margin borrowing - margin. Defaults to margin if not specified (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $currency Currency (required)
     * @param  string $tier VIP level for the floating rate to be queried (optional)
     * @param  int $page Page number (optional, default to 1)
     * @param  int $limit Maximum number of items returned. Default: 100, minimum: 1, maximum: 100 (optional, default to 100)
     *
     * @throws \GateApi\ApiException on non-2xx response
