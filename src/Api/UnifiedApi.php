...
class UnifiedApi
{
    ...
    /**
     * Operation listUnifiedAccountMode
     *
     ...
     */
    public function listUnifiedAccountMode()
    {
        list($response) = $this->listUnifiedAccountModeWithHttpInfo();
        return $response;
    }

    /**
     * Operation listUnifiedAccountModeWithHttpInfo
     *
     * Inquire about unified account mode (deprecated)
     *
     *
     ...
     */
    public function listUnifiedAccountModeWithHttpInfo()
    {
        $request = $this->listUnifiedAccountModeRequest();
    ...
    /**
     * Operation listUnifiedAccountModeAsync
     *
     * Inquire about unified account mode (deprecated)
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUnifiedAccountModeAsync()
    {
        return $this->listUnifiedAccountModeAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listUnifiedAccountModeAsyncWithHttpInfo
     *
     * Inquire about unified account mode (deprecated)
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUnifiedAccountModeAsyncWithHttpInfo()
    {
        $returnType = 'map[string,bool]';
        $request = $this->listUnifiedAccountModeRequest();
    ...
    /**
     * Create request for operation 'listUnifiedAccountMode'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listUnifiedAccountModeRequest()
    {

        $resourcePath = '/unified/account_mode';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation setUnifiedAccountMode
     *
     * Set unified account mode (deprecated)
     *
     * @param  \GateApi\Model\UnifiedMode $unified_mode unified_mode (required)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return map[string,bool]
     */
    public function setUnifiedAccountMode($unified_mode)
    {
        list($response) = $this->setUnifiedAccountModeWithHttpInfo($unified_mode);
        return $response;
    }

    /**
     * Operation setUnifiedAccountModeWithHttpInfo
     *
     * Set unified account mode (deprecated)
     *
     * @param  \GateApi\Model\UnifiedMode $unified_mode (required)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of map[string,bool], HTTP status code, HTTP response headers (array of strings)
     */
    public function setUnifiedAccountModeWithHttpInfo($unified_mode)
    {
        $request = $this->setUnifiedAccountModeRequest($unified_mode);
    ...
    /**
     * Operation setUnifiedAccountModeAsync
     *
     * Set unified account mode (deprecated)
     *
     * @param  \GateApi\Model\UnifiedMode $unified_mode (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setUnifiedAccountModeAsync($unified_mode)
    {
        return $this->setUnifiedAccountModeAsyncWithHttpInfo($unified_mode)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation setUnifiedAccountModeAsyncWithHttpInfo
     *
     * Set unified account mode (deprecated)
     *
     * @param  \GateApi\Model\UnifiedMode $unified_mode (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setUnifiedAccountModeAsyncWithHttpInfo($unified_mode)
    {
        $returnType = 'map[string,bool]';
        $request = $this->setUnifiedAccountModeRequest($unified_mode);
    ...
    /**
     * Create request for operation 'setUnifiedAccountMode'
     *
     * @param  \GateApi\Model\UnifiedMode $unified_mode (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setUnifiedAccountModeRequest($unified_mode)
    {
        // verify the required parameter 'unified_mode' is set
        if ($unified_mode === null || (is_array($unified_mode) && count($unified_mode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unified_mode when calling setUnifiedAccountMode'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($unified_mode)) {
            $_tempBody = $unified_mode;
        }
