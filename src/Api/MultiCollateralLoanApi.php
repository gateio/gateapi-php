...
class MultiCollateralLoanApi
{
     ...
     * @param  string $sort Query the current interest rate of the currency in the previous hour (optional)
     ...
     *
     * @param  string $type Currency type: collateral - Collateral currency, borrow - Borrowing (required)
     * @param  string $currency When it is a collateral currency, multiple currencies can be passed separated by commas;when it is a borrowing currency, only one currenc (required)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string[] $currencies Specify currency name query array, separated by commas, maximum 100items. (required)
