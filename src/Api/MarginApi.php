...
class MarginApi
{
     ...
     * @return \GateApi\Model\Loan[]
     */
    public function listLoans($status, $side, $currency = null, $currency_pair = null, $sort_by = null, $reverse_sort = null, $page = 1, $limit = 100)
    {
        list($response) = $this->listLoansWithHttpInfo($status, $side, $currency, $currency_pair, $sort_by, $reverse_sort, $page, $limit);
        return $response;
    }
     ...
     * @return array of \GateApi\Model\Loan[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listLoansWithHttpInfo($status, $side, $currency = null, $currency_pair = null, $sort_by = null, $reverse_sort = null, $page = 1, $limit = 100)
    {
        $request = $this->listLoansRequest($status, $side, $currency, $currency_pair, $sort_by, $reverse_sort, $page, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listLoansAsync($status, $side, $currency = null, $currency_pair = null, $sort_by = null, $reverse_sort = null, $page = 1, $limit = 100)
    {
        return $this->listLoansAsyncWithHttpInfo($status, $side, $currency, $currency_pair, $sort_by, $reverse_sort, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listLoansAsyncWithHttpInfo($status, $side, $currency = null, $currency_pair = null, $sort_by = null, $reverse_sort = null, $page = 1, $limit = 100)
    {
        $returnType = '\GateApi\Model\Loan[]';
        $request = $this->listLoansRequest($status, $side, $currency, $currency_pair, $sort_by, $reverse_sort, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listLoansRequest($status, $side, $currency = null, $currency_pair = null, $sort_by = null, $reverse_sort = null, $page = 1, $limit = 100)
    {
        ...
        if ($reverse_sort !== null) {
            $queryParams['reverse_sort'] = ObjectSerializer::toQueryValue($reverse_sort);
        }
        // query params
        if ($page !== null) {
            $queryParams['page'] = ObjectSerializer::toQueryValue($page);
