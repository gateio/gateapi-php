...
class MarginApi
{
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $currency Query history for specified currency. If &#x60;currency&#x60; is specified, &#x60;currency_pair&#x60; must also be specified. (optional)
     * @param  string $currency_pair Specify margin account currency pair. Used in combination with &#x60;currency&#x60;. Ignored if &#x60;currency&#x60; is not specified (optional)
     ...
     *
     * @param  string $status Whether to enable auto repayment: &#x60;on&#x60; - enabled, &#x60;off&#x60; - disabled (required)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\AutoRepaySetting
     ...
     * @param  string $currency Query by specified currency, includes all currencies if not specified (optional)
     * @param  int $limit Maximum number of records returned in a single list (optional, default to 100)
