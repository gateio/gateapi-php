...
class SpotApi
{
     ...
     * @param  string $interval Time interval between data points. Note that &#x60;30d&#x60; represents a calendar month, not aligned to 30 days (optional, default to '30m')
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string[][]
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $currency_pair Specify currency pair to get more accurate fee settings.  This field is optional. Usually fee settings are the same for all currency pairs. (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $currency_pairs Maximum 50 currency pairs per request (required)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $type Query by specified account change type. If not specified, all change types will be included. (optional)
     * @param  string $code Specify account change code for query. If not specified, all change types are included. This parameter has higher priority than &#x60;type&#x60; (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $currency_pair Query by specified currency pair. Required for open orders, optional for filled orders (required)
     ...
     * @param  string $currency_pair Specify the trading pair to query. This field is required when querying pending order records. This field can be omitted when querying filled order records. (required)
     * @param  string $account Specify query account (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation getSpotInsuranceHistory
     *
     * Query spot insurance fund historical data
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $business Leverage business, margin - position by position; unified - unified account (required)
     * @param  string $currency Currency (required)
     * @param  int $from Start timestamp in seconds (required)
     * @param  int $to End timestamp in seconds (required)
     * @param  int $page Page number (optional, default to 1)
     * @param  int $limit The maximum number of items returned in the list, the default value is 30 (optional, default to 30)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\SpotInsuranceHistory[]
     */
    public function getSpotInsuranceHistory($associative_array)
    {
        list($response) = $this->getSpotInsuranceHistoryWithHttpInfo($associative_array);
        return $response;
    }

    /**
     * Operation getSpotInsuranceHistoryWithHttpInfo
     *
     * Query spot insurance fund historical data
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\SpotInsuranceHistory[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSpotInsuranceHistoryWithHttpInfo($associative_array)
    {
        $request = $this->getSpotInsuranceHistoryRequest($associative_array);
        ...
        $returnType = '\GateApi\Model\SpotInsuranceHistory[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    /**
     * Operation getSpotInsuranceHistoryAsync
     *
     * Query spot insurance fund historical data
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSpotInsuranceHistoryAsync($associative_array)
    {
        return $this->getSpotInsuranceHistoryAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSpotInsuranceHistoryAsyncWithHttpInfo
     *
     * Query spot insurance fund historical data
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSpotInsuranceHistoryAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\GateApi\Model\SpotInsuranceHistory[]';
        $request = $this->getSpotInsuranceHistoryRequest($associative_array);
    ...
    /**
     * Create request for operation 'getSpotInsuranceHistory'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $business Leverage business, margin - position by position; unified - unified account (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSpotInsuranceHistoryRequest($associative_array)
    {
        // unbox the parameters from the associative array
        $business = array_key_exists('business', $associative_array) ? $associative_array['business'] : null;
        $currency = array_key_exists('currency', $associative_array) ? $associative_array['currency'] : null;
        $from = array_key_exists('from', $associative_array) ? $associative_array['from'] : null;
        $to = array_key_exists('to', $associative_array) ? $associative_array['to'] : null;
        $page = array_key_exists('page', $associative_array) ? $associative_array['page'] : 1;
        ...
        if ($business === null || (is_array($business) && count($business) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $business when calling getSpotInsuranceHistory'
            );
        }
        // verify the required parameter 'currency' is set
        if ($currency === null || (is_array($currency) && count($currency) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency when calling getSpotInsuranceHistory'
            );
        }
        // verify the required parameter 'from' is set
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling getSpotInsuranceHistory'
            );
        }
        // verify the required parameter 'to' is set
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling getSpotInsuranceHistory'
            );
        }
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling SpotApi.getSpotInsuranceHistory, must be bigger than or equal to 1.');
        }

        if ($limit !== null && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling SpotApi.getSpotInsuranceHistory, must be smaller than or equal to 1000.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling SpotApi.getSpotInsuranceHistory, must be bigger than or equal to 1.');
        }


        $resourcePath = '/spot/insurance_history';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($business !== null) {
            if('form' === 'form' && is_array($business)) {
     ...
     * @param  string $market Trading market (optional)
     * @param  string $account Trading account type. Unified account must be set to &#x60;unified&#x60; (optional)
     * @param  int $limit Maximum number of records returned in a single list (optional, default to 100)
