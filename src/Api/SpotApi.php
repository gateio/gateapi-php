...
class SpotApi
{
    ...
    public function getFeeWithHttpInfo($associative_array)
    {
        ...
        try {
            ...
            switch($statusCode) {
            case 200:
                if ('\GateApi\Model\TradeFee' === '\SplFileObject') {
                    $content = $responseBody; //stream goes to serializer
                } else {
                    $content = (string) $responseBody;
                }
                ...
                return [
                        ObjectSerializer::deserialize($content, '\GateApi\Model\TradeFee', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function listAllOpenOrdersWithHttpInfo($associative_array)
    {
        ...
        try {
            ...
            switch($statusCode) {
            case 200:
                if ('\GateApi\Model\OpenOrders[]' === '\SplFileObject') {
                    $content = $responseBody; //stream goes to serializer
                } else {
                    $content = (string) $responseBody;
                }
                ...
                return [
                        ObjectSerializer::deserialize($content, '\GateApi\Model\OpenOrders[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
