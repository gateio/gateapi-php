...
class SpotApi
{
    ...
    public function cancelBatchOrdersWithHttpInfo($cancel_order)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\GateApi\Model\CancelOrderResult[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\GateApi\Model\CancelOrderResult[]', []),
    ...
    public function createBatchOrdersWithHttpInfo($order)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\GateApi\Model\BatchOrder[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\GateApi\Model\BatchOrder[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     */
    public function listOrderBook($currency_pair, $interval = '0', $limit = 10)
    {
     ...
     */
    public function listOrderBookWithHttpInfo($currency_pair, $interval = '0', $limit = 10)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listOrderBookAsync($currency_pair, $interval = '0', $limit = 10)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listOrderBookAsyncWithHttpInfo($currency_pair, $interval = '0', $limit = 10)
    {
        $returnType = '\GateApi\Model\OrderBook';
        $request = $this->listOrderBookRequest($currency_pair, $interval, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listOrderBookRequest($currency_pair, $interval = '0', $limit = 10)
    {
        // verify the required parameter 'currency_pair' is set
        if ($currency_pair === null || (is_array($currency_pair) && count($currency_pair) === 0)) {
            throw new \InvalidArgumentException(
