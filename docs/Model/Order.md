...
**filled_amount** | **string** | Amount filled | [optional] [readonly] 
...
**gt_maker_fee** | **string** | GT amount used to deduct maker fee | [optional] [readonly] 
**gt_taker_fee** | **string** | GT amount used to deduct taker fee | [optional] [readonly] 
