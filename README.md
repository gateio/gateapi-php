...
*AlphaApi* | [**listAlphaAccounts**](docs/Api/AlphaApi.md#listalphaaccounts) | **GET** /alpha/accounts | API for Alpha Accounts
*AlphaApi* | [**listAlphaAccountBook**](docs/Api/AlphaApi.md#listalphaaccountbook) | **GET** /alpha/account_book | Alpha Asset Transaction API
*AlphaApi* | [**quoteAlphaOrder**](docs/Api/AlphaApi.md#quotealphaorder) | **POST** /alpha/quote | Alpha Quotation API
*AlphaApi* | [**listAlphaOrder**](docs/Api/AlphaApi.md#listalphaorder) | **GET** /alpha/orders | Alpha 查询订单列表接口
*AlphaApi* | [**placeAlphaOrder**](docs/Api/AlphaApi.md#placealphaorder) | **POST** /alpha/orders | Alpha Order Placement API
*AlphaApi* | [**getAlphaOrder**](docs/Api/AlphaApi.md#getalphaorder) | **GET** /alpha/order | Alpha 查询单个订单接口
*AlphaApi* | [**listAlphaCurrencies**](docs/Api/AlphaApi.md#listalphacurrencies) | **GET** /alpha/currencies | 查询币种信息
*AlphaApi* | [**listAlphaTickers**](docs/Api/AlphaApi.md#listalphatickers) | **GET** /alpha/tickers | 查询币种ticker
...
*EarnApi* | [**findCoin**](docs/Api/EarnApi.md#findcoin) | **GET** /earn/staking/coins | 链上赚币币种
...
## Documentation For Models
 ...
 - [AccountBookResponse](docs/Model/AccountBookResponse.md)
 ...
 - [Currency2](docs/Model/Currency2.md)
